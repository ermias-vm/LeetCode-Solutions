...
class Test {
    public static void main(String[] args) {
        ...
        System.out.println("Input: numbers = " + Arrays.toString(numbers1) +
                           ", target = " + target1);
        ...
        System.out.println("Input: numbers = " + Arrays.toString(numbers2) +
                           ", target = " + target2);
        ...
        System.out.println("Input: numbers = " + Arrays.toString(numbers3) +
                           ", target = " + target3);
